...
const EmblaCarousel = (props) => {
  ...
  return (
    <div className="embla relative flex place-content-center text-white flex flex-wrap">
      <div className="bg-[#ACA17C] overflow-hidden min-h-screen
                      sm:min-h-0" 
